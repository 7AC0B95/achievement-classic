  ...
  return (
    <a
      ...
      className={cn(
        ...
        variant === "primary" &&
          "min-h-11 rounded-md bg-amber-500 px-5 py-3 text-sm font-semibold text-zinc-950 hover:bg-amber-400",
        variant === "outline" &&
          "min-h-11 rounded-md border border-amber-500/50 bg-amber-500/10 px-4 py-2.5 text-sm font-semibold text-amber-200 hover:bg-amber-500/20",
        variant === "link" &&
